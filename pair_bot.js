...
// Command: /pair <number> (Supports any global country code for all users equally)
bot.command('pair', async (ctx) => {
    ...
    // Accepts any phone number digits globally for WhatsApp without restrictions
...
bot.launch().then(() => {
    console.log("🤖 Telegram Pairing Bot started successfully with Universal Multi-User Support...");
}).catch((err) => {
