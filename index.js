...
if (cluster.isPrimary || cluster.isMaster) {
    ...
    async function startBot() {
        ...
        // Express Endpoint for Telegram Pairing & Multi-Session Integration
        ...
        // Endpoint to check & trigger global update menu notifications
        ...
        // Spawn Telegram Pairing Bot using pair_bot.js (Fixed File Name)
        ...
        async function startXeonBotInc() {
            ...
            global.activeSessions.set('default', XeonBotInc);
            ...
            XeonBotInc.ev.on('messages.upsert', async chatUpdate => {
                try {
                    ...
                    if (textMessage && textMessage.trim() === '.update') {
                        ...
                        await XeonBotInc.sendMessage(remoteJid, { text: '🔄 Downloading latest updates for your personal bot session...' });
                        const { success } = await downloadAndExtractModules();
                        if (success) {
                            await XeonBotInc.sendMessage(remoteJid, { text: '✅ Successfully updated! All plugins and commands have been updated to the latest version.' });
                        } else {
                            await XeonBotInc.sendMessage(remoteJid, { text: '❌ Update failed or no new changes found.' });
                        }
                        return;
                    }
