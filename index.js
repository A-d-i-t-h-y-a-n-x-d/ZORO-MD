...
if (cluster.isPrimary || cluster.isMaster) {
    ...
    async function startBot() {
        ...
        // Express Endpoint for Multi-User Telegram Pairing Integration (Fixed for stable linking)
        app.post('/pair', async (req, res) => {
            ...
            try {
                ...
                const tempSock = makeWASocket({
                    ...
                    browser: ["Chrome", "Desktop", "120.0.0.0"], // Fixed browser config to prevent linking rejection
                    auth: {
                        creds: state.creds,
                ...
                // Wait a brief moment for socket initialization before requesting code
                await delay(3000);
